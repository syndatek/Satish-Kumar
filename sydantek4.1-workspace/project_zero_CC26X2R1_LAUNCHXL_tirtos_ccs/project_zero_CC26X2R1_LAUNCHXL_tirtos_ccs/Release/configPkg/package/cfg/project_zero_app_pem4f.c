 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/tibackup/sydantek4.1-workspace/project_zero_CC26X2R1_LAUNCHXL_tirtos_ccs/project_zero_CC26X2R1_LAUNCHXL_tirtos_ccs/Release/configPkg/package/cfg/project_zero_app_pem4f");

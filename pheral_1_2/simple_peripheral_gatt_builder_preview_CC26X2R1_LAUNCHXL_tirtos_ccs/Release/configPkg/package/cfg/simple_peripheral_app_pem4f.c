 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/tibackup/pheral_1_2/simple_peripheral_gatt_builder_preview_CC26X2R1_LAUNCHXL_tirtos_ccs/Release/configPkg/package/cfg/simple_peripheral_app_pem4f");

...
linker.cmd: package/cfg/simple_peripheral_app_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/simple_peripheral_app_pem4fcfg.cmd\)\"$""\"C:/tibackup/pheral_1_2/simple_peripheral_gatt_builder_preview_CC26X2R1_LAUNCHXL_tirtos_ccs/Release/configPkg/\1\""' package/cfg/simple_peripheral_app_pem4f.xdl > $@

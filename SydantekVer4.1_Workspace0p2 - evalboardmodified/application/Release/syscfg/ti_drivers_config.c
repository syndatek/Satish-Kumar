...
const uint_least8_t CONFIG_GPIO_11_CS_CONST = CONFIG_GPIO_11_CS;
const uint_least8_t CONFIG_GPIO22_PWDN_CONST = CONFIG_GPIO22_PWDN;
const uint_least8_t CONFIG_GPIO_21_1298RST_CONST = CONFIG_GPIO_21_1298RST;
const uint_least8_t CONFIG_GPIO_15adssrt_CONST = CONFIG_GPIO_15adssrt;
const uint_least8_t CONFIG_GPI012_drdy_CONST = CONFIG_GPI012_drdy;
...
const PIN_Config BoardGpioInitTable[CONFIG_PIN_COUNT + 1] = {
    ...
    CONFIG_PIN_11 | PIN_INPUT_EN | PIN_PULLDOWN | PIN_IRQ_DIS,

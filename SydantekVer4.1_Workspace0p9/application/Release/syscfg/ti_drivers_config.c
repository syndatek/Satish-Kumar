...
GPIO_PinConfig gpioPinConfigs[] = {
    ...
    GPIOCC26XX_DIO_08 | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_HIGH,
};
...
const uint_least8_t PWDN_CONST = PWDN;
...
const PIN_Config BoardGpioInitTable[CONFIG_PIN_COUNT + 1] = {
    ...
    /* Parent Signal: CONFIG_GPIO_BTN2 GPIO Pin, (DIO0) */
    ...
    /* Parent Signal: PWDN GPIO Pin, (DIO10) */
    ...
    /* Parent Signal: CONFIG_GPIO_1 GPIO Pin, (DIO8) */

 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/tibackup/SydantekVer4.1_Workspace1p5 -Rtc - wct three channel - debug -0p2/application/Release/configPkg/package/cfg/project_zero_app_pem4f");

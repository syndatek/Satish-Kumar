...
const ADCCC26XX_HWAttrs adcCC26xxHWAttrs[CONFIG_ADC_COUNT] = {
    /* CONFIG_ADC_0 */
    {
        ...
        .samplingDuration    = ADCCC26XX_SAMPLING_DURATION_2P73_MS,
...
GPIO_PinConfig gpioPinConfigs[] = {
    /* CONFIG_GPIO_BTN1 */
    GPIOCC26XX_DIO_03 | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW,
    /* CONFIG_GPIO_BTN2 */
...
const uint_least8_t CONFIG_GPIO_22_PWD_CONST = CONFIG_GPIO_22_PWD;
...
const SPICC26X2DMA_HWAttrs spiCC26X2DMAHWAttrs[CONFIG_SPI_COUNT] = {
    /* CONFIG_SPI_1 */
    {
        ...
        .defaultTxBufValue = 0x55,
        .rxChannelBitMask = 1<<UDMA_CHAN_SSI0_RX,
        .txChannelBitMask = 1<<UDMA_CHAN_SSI0_TX,
        .minDmaTransferSize = 27,
        .mosiPin = IOID_0,
        .misoPin = IOID_2,
        .clkPin  = IOID_1,
...
static unsigned char uartCC26XXRingBuffer0[250];

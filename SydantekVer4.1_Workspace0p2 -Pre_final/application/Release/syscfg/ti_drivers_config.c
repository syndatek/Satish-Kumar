...
GPIO_PinConfig gpioPinConfigs[] = {
    ...
    GPIOCC26XX_DIO_04 | GPIO_CFG_IN_PU | GPIO_CFG_IN_INT_FALLING,
};
...
const uint_least8_t AFE_START_CONST = AFE_START;
const uint_least8_t AFE_RESET_CONST = AFE_RESET;
const uint_least8_t AFE_PRDWN_CONST = AFE_PRDWN;
const uint_least8_t LED1_CONST = LED1;
const uint_least8_t AFE_CS_CONST = AFE_CS;

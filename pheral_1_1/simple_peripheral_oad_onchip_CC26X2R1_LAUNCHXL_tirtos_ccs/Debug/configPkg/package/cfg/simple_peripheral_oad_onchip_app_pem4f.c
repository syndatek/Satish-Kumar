 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/tibackup/pheral_1_1/simple_peripheral_oad_onchip_CC26X2R1_LAUNCHXL_tirtos_ccs/Debug/configPkg/package/cfg/simple_peripheral_oad_onchip_app_pem4f");

...
linker.cmd: package/cfg/project_zero_app_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/project_zero_app_pem4fcfg.cmd\)\"$""\"C:/tibackup/newproject/project_zero_CC26X2R1_LAUNCHXL_tirtos_ccs/Release/configPkg/\1\""' package/cfg/project_zero_app_pem4f.xdl > $@

...
.libraries,project_zero_app.pem4f: package/cfg/project_zero_app_pem4f.xdl
	$(MAKE) -f C:\tibackup\SydantekVer4.1_Workspace1p4\application/src/makefile.libs

clean::
	$(MAKE) -f C:\tibackup\SydantekVer4.1_Workspace1p4\application/src/makefile.libs clean

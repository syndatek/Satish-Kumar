...
linker.cmd: package/cfg/project_zero_app_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/project_zero_app_pem4fcfg.cmd\)\"$""\"C:/tibackup/SydantekVer4.1_Workspace1p5/application/Release/configPkg/\1\""' package/cfg/project_zero_app_pem4f.xdl > $@
